...
def CNN_train(loader, model, optimizer, criterion, args):
    losses = AverageMeter()
    acc = Accuracy(task='multiclass', num_classes=7).cuda()
...
def main():
    ...
    for i in range(args.ex_epochs):
        ...
        print('data loading ..')
        trainset, testset, valset = Data_Loader(path_list, args)
        ...
        for epoch in range(args.start_epoch, args.epochs):
            ...
            CNN_train(train_loader, model, optimizer, criterion, args)
